/*
 * @Author       : STY
 * @Date         : 2020-09-20 17:28:56
 * @LastEditors  : STY
 * @LastEditTime : 2022-08-01 09:28:55
 * @FilePath     : \cache-server\caches\value.go
 * @Description  :
...
const (
	// NeverDie 是一个常量，设计的时候规定如果ttl为 0，那么永不过期
	NeverDie = 0
)

// value 是对数据进一步封装的结构体，加寿命与出生时间
type value struct {
